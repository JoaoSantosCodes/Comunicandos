  ...
  return (
    <div className="animate-fade-in" style={{ maxWidth: "800px", margin: "0 auto" }}>
      <div className="panel-card" style={{ padding: "28px" }}>
        ...
        <div style={{ backgroundColor: "var(--bg-dark-hover)", border: "1px solid var(--border-color)", borderRadius: "14px", padding: "20px", marginBottom: "24px" }}>
          <h3 style={{ fontSize: "0.95rem", fontWeight: 700, color: "#2f6ea8", marginBottom: "12px", display: "flex", alignItems: "center", gap: "8px" }}>
            <ShieldCheck size={18} />
        ...
        <div style={{ backgroundColor: "var(--paper)", border: "1px solid var(--border-color)", borderRadius: "14px", padding: "20px", marginBottom: "24px" }}>
          <span style={{ fontSize: "0.72rem", fontWeight: 700, color: "var(--text-muted)", textTransform: "uppercase" }}>Comunicado Selecionado para Envio</span>
          <h4 style={{ fontSize: "1.1rem", fontWeight: 700, color: "var(--text-main)", marginTop: "4px" }}>
            ...
            {[
              ...
              <label
                ...
                style={{
                  ...
                  padding: "14px",
                  borderRadius: "8px",
                  border: channels[ch.id] ? "2px solid var(--accent-red)" : "1px solid var(--border-color)",
                  backgroundColor: channels[ch.id] ? "rgba(200, 55, 45, 0.08)" : "var(--bg-dark-hover)",
                  cursor: "pointer"
                }}
              >
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                  <span style={{ fontSize: "0.9rem", fontWeight: 700, color: "var(--text-main)" }}>{ch.label}</span>
                  <input
                    type="checkbox"
                ...
                <span style={{ fontSize: "0.72rem", color: "var(--text-muted)", marginTop: "4px" }}>{ch.desc}</span>
              </label>
            ))}
          </div>
        </div>
