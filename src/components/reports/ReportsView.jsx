    ...
    <div className="animate-fade-in" style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "20px" }}>
        <div className="panel-card" style={{ textAlign: "center", padding: "30px" }}>
          <Clock size={36} style={{ color: "#3b82f6", margin: "0 auto 10px auto" }} />
          <h3 style={{ fontSize: "1.8rem", fontWeight: 800, color: "#fff" }}>01h 42m</h3>
          <p style={{ fontSize: "0.85rem", color: "#9ca3af" }}>Tempo Médio de Resolução (MTTR)</p>
        </div>

        <div className="panel-card" style={{ textAlign: "center", padding: "30px" }}>
          <TrendingDown size={36} style={{ color: "#10b981", margin: "0 auto 10px auto" }} />
          <h3 style={{ fontSize: "1.8rem", fontWeight: 800, color: "#fff" }}>-18%</h3>
          <p style={{ fontSize: "0.85rem", color: "#9ca3af" }}>Redução de Incidentes P1 no Mês</p>
        </div>

        <div className="panel-card" style={{ textAlign: "center", padding: "30px" }}>
          <ShieldCheck size={36} style={{ color: "#8b5cf6", margin: "0 auto 10px auto" }} />
          <h3 style={{ fontSize: "1.8rem", fontWeight: 800, color: "#fff" }}>99.4%</h3>
          <p style={{ fontSize: "0.85rem", color: "#9ca3af" }}>Conformidade SLA de Comunicação</p>
        </div>
      </div>
    </div>
  );
